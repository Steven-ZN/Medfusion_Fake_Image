...
if __name__ == "__main__":
    ...
    ds = CheXpert_2_Dataset( #  256x256
        augment_horizontal_flip=False,
        augment_vertical_flip=False,
        path_root = '/data/students/IS24FA/stevenz/ldm/BUSI_Split/train/',
        image_resize=512
    )
    ...
    latent_embedder = VAE
    latent_embedder_checkpoint = '/data/students/IS24FA/stevenz/ldm_3/medfusion/scripts/runs/2024_11_09_215003/last.ckpt' #model with 1 and 0
    #'/data/students/IS24FA/stevenz/ldm_3/medfusion/scripts/runs/2024_11_10_194221/epoch=896-step=28700.ckpt'# model with only 1
    # ------------ Initialize Pipeline ------------1111
