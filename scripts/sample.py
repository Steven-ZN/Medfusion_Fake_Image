...
if __name__ == "__main__":
    ...
    #pipeline = DiffusionPipeline.load_from_checkpoint('/data/students/IS24FA/stevenz/ldm_3/medfusion/scripts/runs/2024_11_11_101534/last.ckpt')
    #pipeline = DiffusionPipeline.load_from_checkpoint('/data/students/IS24FA/stevenz/ldm_3/medfusion/scripts/runs/2024_11_10_140243/last.ckpt')
    pipeline = DiffusionPipeline.load_from_checkpoint('/data/students/IS24FA/stevenz/ldm_3/medfusion/scripts/runs/2024_11_12_185308/epoch=924-step=22200.ckpt')
    pipeline.to(device)
    ...
    for cond in [1]:
        ...
        un_cond = torch.tensor([0] * n_samples, device=device)

        # ----------- Run --------
        results = pipeline.sample(n_samples, (8, 64,64), guidance_scale=5, condition=condition, un_cond=un_cond, steps=steps, use_ddim=use_ddim )
